...
Чтобы на каждой итерации понимать контекст нынешней последовательности, 
достаточно двух переменных: 
в одной нужно сохранять предыдущий элемент, 
а в другой, к примеру, - True, если последовательность возрастающая, 
и False, если она убывающая. 

Дальше нужно отдельно разбирать случаи для начала новой подпоследовательности
(когда предыдущий элемент None или вторая переменная None). 

Также отдельно нужно рассматривать случаи, когда два одинаковых элемента идут подряд. 
Во первых, это означает обязательное завершение нынешней последовательности, 
а во вторых - при начале следующей нельзя брать нынешние 2 элемента, а можно только 1. 
И, соответственно, is_increasing нужно устанавливать как None, 
так как в подпоследовательности пока только 1 элемент и неизвестно, 
будет она возрастающая или убывающая.
"""
best = 0 
curr = 0 
