...
Другими словами, мы находим максимальное количество комбинаций 
из всех возможных букв (т.е сколько раз мы сможем взять abc) и ставим их. 
Понятно, что это кол-во будет равно наименьшему кол-ву из всех букв. 
Эти буквы из доступных убираем, 
а к ответу прибавляем кол-во таких комбинаций умножить на хорошесть, 
которую они дают (это длина минус 1). 
Затем повторяем алгоритм для последовательностей букв 
короче на 1 и так перебираем все возможные варианты. 
